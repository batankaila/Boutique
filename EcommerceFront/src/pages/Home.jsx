...
export default function Home() {
  ...
  const videoLgUrl = "/videos/videoMd.mp4";
  ...
  return (
    <>
      ...
      <section className=" h-[500px] md:h-[900px] lg:h-screen">
        ...
        >
          ...
          <div className="absolute w-full h-full">
            <div className=" container md:mx-auto h-full lg:pl-10 flex justify-center  items-end relative">
              <div className="lg:static transform transition-transform ease-in-out duration-500 absolute lg:left-10 md:bottom-30 left-5 md:left-0 bottom-30 ">
                ...
                <div className=" flex flex-col">
                  <Link className=" no-underline justify-center text-black" to={"/Bundle"}>
                    <button className="flex items-center gap-2 mb-4  bg-pink-400 hover:text-[#ff2e3f]  font-bold px-4 py-1 text-lg uppercase outline outline-2 outline-white outline-offset-4 hover:outline-[#e22750]">
                      <span>SHOP NOW!!! </span>
                ...
                <div className=" flex flex-col">
                  <Link className=" no-underline justify-center text-black" to={"/register"}>
                    <button className="flex items-center gap-2 mb-4  bg-pink-400 hover:text-[#ff2e3f]  font-bold px-4 py-1 text-lg uppercase outline outline-2 outline-white outline-offset-4 hover:outline-[#e22750]">
                      Be a Seller
                      <ArrowLongRightIcon className="h-6 w-6 " />
                    </button>
      ...
      <div className="mx-auto bg-pink-100  whitespace-nowrap overflow-x-auto scroll-behavior-smooth">
        <Slider
          link={"/product"}
